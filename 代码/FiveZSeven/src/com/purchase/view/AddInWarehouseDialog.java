...
public class AddInWarehouseDialog extends JDialog {
	...
	public AddInWarehouseDialog() {
		...
		try {
			...
			houseModel.setSelectedItem(null);
	...
	public void setPurchase(Purchase p) {
		if(p!=null) {
			orderModel.setSelectedItem(p.getOid());
			txtWName.setText(p.getBaleName());
			txtWeight.setText(p.getMount());
		}		
	}
}
