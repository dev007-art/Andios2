...
public class UpdateInWarehouseFrame extends MyFrame {
	...
	private InWarehouse t;
	
	public UpdateInWarehouseFrame() {
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					t.setRemark(remark);
					Client.inWarehouseDao.update(t, Session.getToken());
	...
	public void setId(int id) {
		try {
			t = Client.inWarehouseDao.get(id, Session.getToken());
			cbOid.setSelectedItem(t.getOid());
			cbDid.setSelectedItem(Client.warehouseDao.get(t.getDid(), Session.getToken()));
			txtJoinTime.setText(t.getJoinTime());
			txtWeight.setText(String.valueOf(t.getWeight()));
			txtWName.setText(t.getWareName());
